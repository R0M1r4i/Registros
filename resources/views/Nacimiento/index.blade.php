...
@section('content')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <h6>Buscar Acta de Nacimiento</h6>
                                ...
                                <div class="col-sm-3 " style="margin-top: 15px">
                                    ...
                                    <h6>Total de Actas de Nacimiento: <strong id="contador-registros">{{ $totalNacimientos }}</strong></h6>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover mb-0">
                                    ...
                                    @foreach ($nacimientos as $nacimiento)
                                        <tr>
                                            <td class="text-bold-500">{{ $nacimiento->nombres }}</td>
                                            <td>{{ $nacimiento->apellidos }}</td>
                                            <td class="text-bold-500">{{ \Carbon\Carbon::parse($nacimiento->f_nacimiento)->format('d/m/Y') }}</td>
                                            <td>
                                                <div class="buttons">
                                                    <a href="{{ route('nacimiento.edit', $nacimiento->id) }}" class="btn icon icon-left btn-primary">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
            ...
            <div class="modal-content">
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Registrar Nueva Acta de Nacimiento</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
    ...
    <script>
        ...
        function cargarActas(page = 1) {
            ...
            fetch(`/buscar-acta-nacimiento?query=${query}&page=${page}`)
                ...
                .then(data => {
                    ...
                    if (data.data.length > 0) {
                        ...
                        <td>
                            <div class="buttons">
                                <a href="/nacimiento/${acta.id}/edit/" class="btn icon icon-left btn-primary">
                                    <i data-feather="edit"></i> Detalles
                                </a>
                            </div>
                        </td>
