...
@section('content')
    ...
    <div class="page-content">
        <section class="row">
            <div class="col-12 col-lg-12">
                            ...
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{$matrimonio->nombres}} {{$matrimonio -> apellidos}}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ Carbon::parse($matrimonio->f_nacimiento)->format('d/m/Y') }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editModal{{ $matrimonio->id }}">
                    ...
                    <div class="card">
                        <div class="card-content">
                            ...
                            <div class="pdf-viewer ">
                                <iframe src="{{ Storage::url($matrimonio->ruta_doc) }}" width="100%" height="600px"></iframe>
                            </div>
    ...
    <div class="modal fade" id="editModal{{ $matrimonio->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $matrimonio->id }}" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel{{ $matrimonio->id }}">Editar Registro</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('matrimonio.update', $matrimonio->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="nombres" class="form-control" value="{{ $matrimonio->nombres }}" required
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="apellidos" class="form-control" value="{{ $matrimonio->apellidos }}" required
                                   maxlength="255" pattern="[A-Za-zÁÉÍÓÚáéíóúÑñ\s]+"
                                   title="El campo solo puede contener letras y espacios."
                            >
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="f_nacimiento" name="f_nacimiento" class="form-control" value="{{ old('f_nacimiento', \Carbon\Carbon::parse($matrimonio->f_nacimiento)->format('d/m/Y')) }}" required
                                   pattern="\d{2}/\d{2}/\d{4}"
