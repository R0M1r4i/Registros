...
@section('content')
        ...
        <div class="page-title">
            <div class="row">
                ...
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Tabla de Actas de Defuncion</h3>
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Acta de Defuncion</li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <h6>Buscar Acta de Defuncion</h6>
                                ...
                                <div class="col-sm-3 " style="margin-top: 15px">
                                    ...
                                    <h6>Total de Actas de Defuncion: <strong id="contador-registros">{{ $totalDefunsiones }}</strong></h6>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
            ...
            <div class="modal-content">
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Registrar Nueva Acta de Defuncion</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
    ...
    <script>
        ...
        function cargarActas(page = 1) {
            ...
            fetch(`/buscar-acta-defuncion?query=${query}&page=${page}`)
                ...
                .then(data => {
                    ...
                    if (data.data.length > 0) {
                        ...
                        <td>
                            <div class="buttons">
                                <a href="/defuncion/${acta.id}/edit/" class="btn icon icon-left btn-primary">
                                    <i data-feather="edit"></i> Detalles
                                </a>
                            </div>
                        </td>
        ...
        // Función para generar los enlaces de paginación con números de página
